  ...
  return (
    <nav className="fixed top-0 left-0 w-full z-50 text-white text-[clamp(1rem,1.7vw,1.7vw)] leading-[1.4] bg-black">
      <motion.div
        ...
        initial="hidden"
        animate="visible"
        className="absolute z-50 w-full bg-black mx-auto px-6 py-4 flex justify-between items-center">
      ...
      <AnimatePresence>
        {menuOpen && (
          <motion.div
            className="fixed top-0 left-0 w-full h-full bg-black text-white z-40 flex items-center justify-center"
